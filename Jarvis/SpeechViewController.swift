...
class SpeechViewController: UIViewController, SFSpeechRecognizerDelegate, UIPopoverPresentationControllerDelegate {
    ...
    @objc var textItem : String?
    @objc var manualBtn3 = UIButton()
    @objc var keyBtn3 = UIButton()
    @objc var ref : DatabaseReference?
    var handle : DatabaseHandle?
    @objc var KeyDic : [[String : Int]] = []
    @objc var count : Int = 0
    @objc let KeyListDic = ["교통", "교육", "의료", "관광", "금융", "식품"]
    @objc var pickOption = ["20대", "30대", "40대", "50대"]
    @objc var dic1 : [String : Int]? = [:]
    @objc var dic2 : [String : String] = [:]
    @objc var str : String? = nil
    ...
    @objc let synthesizer = AVSpeechSynthesizer()
    @objc var speaktext : String = ""
    ...
    @objc func popOver(_ iden : String, _ send : UIButton) {
    ...
    @objc func popOver2(_ send :UIButton){
        let storyboard : UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
    ...
    @objc func KeywordAnalysis(_ keyWord : String) {// 키워드 카운트 관리
    ...
    @objc func gotoParsing(sendAnalysis isSendAnalysis: Bool = false) {
    ...
    @objc func loop(_ text : String) -> Bool{
        var bool : Bool = false
