...
class MyMenuViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @objc var myList : Set<String> = []
    @objc var Middle : [[String : Int]] = []
    var News = [BookMarks]()
    @objc var TotalList : [[String : String]] = []
    ...
    override func viewDidLoad() {
        ...
        segment.setTitleTextAttributes([NSFontAttributeName : UIFont(name: "THECandybar", size: 20)!], for: .normal)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //print(result[indexPath.row].count)
        if segment.selectedSegmentIndex == 1 {
